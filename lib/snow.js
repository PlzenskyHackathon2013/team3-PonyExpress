...
var no = 50; // No of images should fall
...
for (i = 0; i < no; ++ i) {
	...
	document.write("<div id=\"dot"+ i +"\" style=\"POSITION: absolute; Z-INDEX: "+ i +"; VISIBILITY: visible; TOP: 15px;LEFT: 15px;\"><img src='"+image+Math.floor((Math.random()*numOfRandom)+1)+".png' border=\"0\"><\/div>");
}
